...
| 版本   | 更新日期   | 编辑                 | 说明                                          |
+========+============+======================+===============================================+
| v2.9.0 | 2022.09.16 | 唐斌                 | 添加采购管理、干系人管理各个过程的数据流图    |
+--------+------------+----------------------+-----------------------------------------------+
| v2.8.0 | 2022.09.16 | 唐斌                 | 使用矢量图重做人力资源管理数据流图            |
+--------+------------+----------------------+-----------------------------------------------+
| v2.7.0 | 2022.09.15 | 唐斌                 | 添加沟通管理各个过程的数据流图                |
+--------+------------+----------------------+-----------------------------------------------+
| v2.6.0 | 2022.09.15 | 唐斌                 | 添加质量管理各个过程的数据流图                |
+--------+------------+----------------------+-----------------------------------------------+
| v2.5.0 | 2022.09.14 | 唐斌                 | 添加成本管理各个过程的数据流图                |
+--------+------------+----------------------+-----------------------------------------------+
| v2.4.0 | 2022.09.13 | 唐斌                 | 添加进度管理各个过程的数据流图                |
+--------+------------+----------------------+-----------------------------------------------+
| v2.3.0 | 2022.09.11 | 唐斌                 | 添加范围管理各个过程的数据流图                |
+--------+------------+----------------------+-----------------------------------------------+
| v2.2.2 | 2022.09.11 | 唐斌                 | 修复控制风险输入的错误                        |
+--------+------------+----------------------+-----------------------------------------------+
